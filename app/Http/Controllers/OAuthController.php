...
class OAuthController extends Controller
{
    ...
    public function handleGoogleCallback(Request $request)
    {
        ...
        $defaultPassword = 'DefaultPassword123!'; // You can use a more complex method for generating passwords

        // Find the user by email, or create a new user with the default password
        $user = User::updateOrCreate(
            ...
            [
                ...
                'password' => Hash::make($defaultPassword) // Store the hashed password
            ]
        );
